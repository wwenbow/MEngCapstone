...
the legs. I calibrated the legs so the motion was smooth and quick. However, due
to power supply issues we could not get the robot to walk properly. The power
supplies we had were not able to control the simultaneous motion of 12 servos,
which had support the load of heavy robotic legs. The next step for the robot
will be to get a power supply capable of supporting the many servos on the robot.
