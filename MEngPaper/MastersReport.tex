...
\paragraph{} Tests were done on the control system and servos to make sure every
system function correctly. Software performance was tested using the hardware
